...
public class NetworkManager : MonoBehaviourPunCallbacks {
    ...
    public void CreateAndJoinRoom () {
        ...
        ExitGames.Client.Photon.Hashtable customRoomProperties = new ExitGames.Client.Photon.Hashtable { { "Stage", stageName }, { "Difficulty", stageDifficulty }
        };
